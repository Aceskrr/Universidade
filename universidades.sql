...
CALL MatricularAluno('Matheus', 'Silva', 'Engenharia Civil', 'Engenharia');
CALL MatricularAluno('Maria', 'Fernandes', 'Psicologia', 'Ciências Humanas');
CALL MatricularAluno('Pedro', 'Almeida', 'Medicina', 'Saúde');
CALL MatricularAluno('Gabriel', 'Souza', 'Computação', 'Tecnologia');
CALL MatricularAluno('Luana', 'Pereira', 'Desenho Industrial', 'Artes');
CALL MatricularAluno('Beatriz', 'Tralha', 'Engenharia Civil', 'Engenharia');
CALL MatricularAluno('Guilherme', 'Prestes', 'Psicologia', 'Ciências Humanas');
CALL MatricularAluno('Ana', 'Almeida', 'Medicina', 'Saúde');
CALL MatricularAluno('Rafael', 'Sonza', 'Computação', 'Tecnologia');
CALL MatricularAluno('Lara', 'Fagundes', 'Desenho Industrial', 'Artes');
CALL MatricularAluno('André', 'Miguel', 'Engenharia Civil', 'Engenharia');
CALL MatricularAluno('Gabriela', 'Fernandes', 'Psicologia', 'Ciências Humanas');
CALL MatricularAluno('Felipe', 'Gonçalves', 'Medicina', 'Saúde');
CALL MatricularAluno('Isabela', 'Souza', 'Computação', 'Tecnologia');
CALL MatricularAluno('Leonardo', 'Tigre', 'Desenho Industrial', 'Artes');
CALL MatricularAluno('Luana', 'Piovani', 'Engenharia Civil', 'Engenharia');
CALL MatricularAluno('Bruno', 'Kozada', 'Psicologia', 'Ciências Humanas');
CALL MatricularAluno('Letícia', 'Limeira', 'Medicina', 'Saúde');
CALL MatricularAluno('Matheus', 'Bianchi', 'Computação', 'Tecnologia');
CALL MatricularAluno('Laura', 'Barros', 'Desenho Industrial', 'Artes');
CALL MatricularAluno('Lucas', 'Colaço', 'Engenharia Civil', 'Engenharia');
CALL MatricularAluno('Carolina', 'Braz', 'Psicologia', 'Ciências Humanas');
CALL MatricularAluno('Gustavo', 'Ariel', 'Medicina', 'Saúde');
CALL MatricularAluno('Vanessa', 'Mattos', 'Computação', 'Tecnologia');
CALL MatricularAluno('Thiago', 'Silveira', 'Desenho Industrial', 'Artes');
CALL MatricularAluno('Amanda', 'Tsuiomi', 'Engenharia Civil', 'Engenharia');
CALL MatricularAluno('Diego', 'Bernardo', 'Psicologia', 'Ciências Humanas');
